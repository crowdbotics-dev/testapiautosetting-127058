...
## Project Structure
    ...
    ├── testapiautosetting_127058  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127058`
...
2. Clone this repo and `cd testapiautosetting_127058`
